...
# floyd run --gpu --env tensorflow-1.12 --data arista/datasets/featuremaps-jsc/2:datasets "python trainer.py"
...
def main(parameters):
    ...
    data_gen_train = data.DataWindowGenerator(params, 'training')
    ...
    train_spec = tf.estimator.TrainSpec(
        lambda: data.input_fn(data_gen_train, True, parameters),
